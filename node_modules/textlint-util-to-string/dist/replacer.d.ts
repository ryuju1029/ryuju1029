...
export declare const maskValue: (maskSymbol: string) => StringSourceReplacerMaskValueCommand;
export declare const emptyValue: () => StringSourceReplacerEmptyValueCommand;
export declare const handleReplacerCommand: <T extends TxtNode | UnistNode>(command: StringSourceReplacerCommand, node: T) => T;
